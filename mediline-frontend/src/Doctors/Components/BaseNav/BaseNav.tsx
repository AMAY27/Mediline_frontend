...
const BaseNav = () => {
  return (
    <div className='flex flex-col items-center bg-green-800 pt-5 w-[7%] h-screen'>
        ...
        <div className='flex flex-col items-center text-center text-sm break-words w-full py-2 text-white mb-4 bg-green-600'>
            <div className='text-3xl'>
                <SlScreenDesktop/>
            </div>
            <h2>Admin</h2>
        </div>
        <div className='flex flex-col items-center text-center text-sm break-words mb-4 text-white'>
            <div className='text-3xl'>
                <MdManageAccounts/>
            </div>
            <h2>Patients</h2>
